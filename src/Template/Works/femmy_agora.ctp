...
<section class="bg_color_mono_clear padding_v_large">
    <div class="container">
        ...
        <div class="margin_b_medium bg_mono_light padding_medium">
            ...
            <div class="site_info">
                <div class="thmb_img margin_b_medium">
                    <figure>
                        <?php echo $this->Html->image('works/site/works_thmb_agora_pc.jpg', array('alt' => 'アゴラサイトトップページ画像')); ?>
                    </figure>
                </div>
                <div class="site_info_text padding_medium">
                <h4 class="headline">クライアント</h4>
                    <p class="margin_b_medium">フェミークリニック</p>
                    <h4 class="headline">サイト規模</h4>
                    <p class="margin_b_medium">46ページ</p>
                    <h4 class="headline">URL</h4>
                    <p class="margin_b_medium">https://f-drcosme.com/</p>
                    <h4 class="headline">月間PV数（2021/01）</h4>
                    <p class="margin_b_medium">549</p>
        ...
        <div class="site_images">
            <div class="col1">
                <figure>
                    <?php echo $this->Html->image('works/site/works_agora_01.jpg', array('alt' => 'アゴラサイトトップページ画像')); ?>
                </figure>
            </div>
        </div>
        ...
        <div class="site_images">
            <div class="col2">
                <figure class="">
                    <?php echo $this->Html->image('works/site/works_agora_02.jpg', array('alt' => 'アゴラサイトトップページ全画面画像')); ?>
                </figure>
                <figure class="">
                    <?php echo $this->Html->image('works/site/works_agora_03.jpg', array('alt' => 'アゴラサイト下層ページ画像')); ?>
                </figure>
            </div>
            <div class="col1">
                <figure>
                    <?php echo $this->Html->image('works/site/works_agora_04.jpg', array('alt' => 'アゴラサイトスマホデバイスモックアップ画像')); ?>
                </figure>
            </div>
        </div>
        <div class="link_box">
