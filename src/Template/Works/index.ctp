                ...
                <ul class="nav-list">
                    <li>
                        <div>
                            ...
                            <!-- <div class="nav-show-all" id="nav-show-all">
                                <input type="radio" id="nav-input-all" name="nav-input" class="nav-input" data-sort-nav="show-all" checked>
                                <label for="nav-input-all" id="show-all" class="nav-child-inner"><span>全て見る</span></label>
                            </div> -->
                        </div>
                        <ul class="nav-child">
                            <li>
                            ...
                            <li>
                                ...
                                <label for="nav-input-fruits" id="fruits" class="nav-child-inner"><div class="nav-txt">web</div></label>
                            </li>
                            <li>
                                <input type="radio" id="nav-input-vegetables" name="nav-input" class="nav-input" data-sort-nav="banner">
                                <label for="nav-input-vegetables" id="vegetables" class="nav-child-inner"><div class="nav-txt">banner</div></label>
                            </li>
                        </ul>
                    </li>
                </ul>
