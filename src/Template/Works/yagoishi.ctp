...
<section class="bg_color_mono_clear padding_v_large">
    <div class="container">
        <h2 class="headline">
            八事石坂クリニック
            <span class="headline_large_en">yagotoishizaka clinic</span>
        </h2>
        ...
        <div class="margin_b_medium bg_mono_light padding_medium">
            ...
            <div class="site_info">
                <div class="thmb_img margin_b_medium">
                    <figure>
                        <?php echo $this->Html->image('works/site/works_thmb_yagoishi_pc.jpg', array('alt' => '八事石坂クリニックサイトトップページ画像')); ?>
                    </figure>
                </div>
                <div class="site_info_text padding_medium">
                <h4 class="headline">クライアント</h4>
                    <p class="margin_b_medium">八事石坂クリニック</p>
                    <h4 class="headline">サイト規模</h4>
                    <p class="margin_b_medium">185ページ</p>
                    <h4 class="headline">URL</h4>
                    <p class="margin_b_medium">https://www.yagoishi.com/</p>
                    <h4 class="headline">月間PV数（2021/01）</h4>
                    <p class="margin_b_medium">8,579</p>
        ...
        <div class="site_images">
            <div class="col1">
                <figure>
                    <?php echo $this->Html->image('works/site/works_yagoishi_01.jpg', array('alt' => '八事石坂クリニックサイトトップページ画像')); ?>
                </figure>
            </div>
        </div>
        ...
        <div class="site_images">
            <div class="col2">
                <figure class="">
                    <?php echo $this->Html->image('works/site/works_yagoishi_02.jpg', array('alt' => '八事石坂クリニックサイトトップページ全画面画像')); ?>
                </figure>
                <figure class="">
                    <?php echo $this->Html->image('works/site/works_yagoishi_03.jpg', array('alt' => '八事石坂クリニックサイト下層ページ画像')); ?>
                </figure>
            </div>
            <div class="col1">
                <figure>
                    <?php echo $this->Html->image('works/site/works_yagoishi_04.jpg', array('alt' => '八事石坂クリニックサイトスマホデバイスモックアップ画像')); ?>
                </figure>
            </div>
        </div>
        <div class="link_box">
