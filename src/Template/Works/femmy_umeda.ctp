...
<section class="bg_color_mono_clear padding_v_large">
    <div class="container">
        <h2 class="headline">
            フェミークリニック梅田院
            <span class="headline_large_en">femmy clinic umeda</span>
        </h2>
        ...
        <div class="margin_b_medium bg_mono_light padding_medium">
            ...
            <div class="site_info">
                <div class="thmb_img margin_b_medium">
                    <figure>
                        <?php echo $this->Html->image('works/site/works_thmb_femmy_umeda_pc.jpg', array('alt' => 'フェミークリニック梅田院サイトトップページ画像')); ?>
                    </figure>
                </div>
                <div class="site_info_text padding_medium">
                <h4 class="headline">クライアント</h4>
                    <p class="margin_b_medium">フェミークリニック梅田院</p>
                    <h4 class="headline">サイト規模</h4>
                    <p class="margin_b_medium">140ページ</p>
                    <h4 class="headline">URL</h4>
                    <p class="margin_b_medium">https://femmy.osaka.jp/</p>
                    <h4 class="headline">月間PV数（2021/01）</h4>
                    <p class="margin_b_medium">2,912</p>
        ...
        <div class="site_images">
            <div class="col1">
                <figure>
                    <?php echo $this->Html->image('works/site/works_femmy_umeda_01.jpg', array('alt' => 'フェミークリニック梅田院サイトトップページ画像')); ?>
                </figure>
            </div>
        </div>
        ...
        <div class="site_images">
            <div class="col2">
                <figure class="">
                    <?php echo $this->Html->image('works/site/works_femmy_umeda_02.jpg', array('alt' => 'フェミークリニック梅田院サイトトップページ全画面画像')); ?>
                </figure>
                <figure class="">
                    <?php echo $this->Html->image('works/site/works_femmy_umeda_03.jpg', array('alt' => 'フェミークリニック梅田院サイト下層ページ画像')); ?>
                </figure>
            </div>
            <div class="col1">
                <figure>
                    <?php echo $this->Html->image('works/site/works_femmy_umeda_04.jpg', array('alt' => 'フェミークリニック梅田院サイトスマホデバイスモックアップ画像')); ?>
                </figure>
            </div>
        </div>
        <div class="link_box">
