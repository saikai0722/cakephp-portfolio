...
<section class="bg_color_mono_clear padding_v_large">
    <div class="container">
        ...
        <div class="margin_b_medium bg_mono_light padding_medium">
            ...
            <div class="site_info">
                <div class="thmb_img margin_b_medium">
                    <figure>
                        <?php echo $this->Html->image('works/site/works_thmb_femmy_shibuya_pc.jpg', array('alt' => 'フェミークリニック渋谷院サイトトップページ画像')); ?>
                    </figure>
                </div>
                <div class="site_info_text padding_medium">
                <h4 class="headline">クライアント</h4>
                    <p class="margin_b_medium">フェミークリニック渋谷院</p>
                    <h4 class="headline">サイト規模</h4>
                    <p class="margin_b_medium">63ページ</p>
                    <h4 class="headline">URL</h4>
                    <p class="margin_b_medium">https://www.shibuya-femmy.net/</p>
                    <h4 class="headline">月間PV数（2021/01）</h4>
                    <p class="margin_b_medium">3,332</p>
        ...
        <div class="site_images">
            <div class="col1">
                <figure>
                    <?php echo $this->Html->image('works/site/works_femmy_shibuya_01.jpg', array('alt' => 'フェミークリニック渋谷院サイトトップページ画像')); ?>
                </figure>
            </div>
        </div>
        ...
        <div class="site_images">
            <div class="col2">
                <figure class="">
                    <?php echo $this->Html->image('works/site/works_femmy_shibuya_02.jpg', array('alt' => 'フェミークリニック渋谷院サイトトップページ全画面画像')); ?>
                </figure>
                <figure class="">
                    <?php echo $this->Html->image('works/site/works_femmy_shibuya_03.jpg', array('alt' => 'フェミークリニック渋谷院サイト下層ページ画像')); ?>
                </figure>
            </div>
            <div class="col1">
                <figure>
                    <?php echo $this->Html->image('works/site/works_femmy_shibuya_04.jpg', array('alt' => 'フェミークリニック渋谷院サイトスマホデバイスモックアップ画像')); ?>
                </figure>
            </div>
        </div>
        <div class="link_box">
