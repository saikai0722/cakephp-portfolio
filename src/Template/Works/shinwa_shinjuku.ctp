...
<section class="bg_color_mono_clear padding_v_large">
    <div class="container">
        <h2 class="headline">
            親和クリニック新宿院
            <span class="headline_large_en">shinwa shinjuku</span>
        </h2>
        ...
        <div class="margin_b_medium bg_mono_light padding_medium">
            ...
            <div class="site_info">
                <div class="thmb_img margin_b_medium">
                    <figure>
                        <?php echo $this->Html->image('works/site/works_thmb_shinwa_shinjuku_pc.jpg', array('alt' => '親和クリニックサイトトップページ画像')); ?>
                    </figure>
                </div>
                ...
                <h4 class="headline">クライアント</h4>
                    ...
                    <p class="margin_b_medium">263ページ</p>
                    <h4 class="headline">URL</h4>
                    <p class="margin_b_medium">https://shinwa-shinjuku.jp/</p>
                    <h4 class="headline">月間PV数（2021/01）</h4>
                    <p class="margin_b_medium">3,102</p>
        ...
        <div class="site_images">
            <div class="col1">
                <figure>
                    <?php echo $this->Html->image('works/site/works_shinwashinwa_shinjuku_01.jpg', array('alt' => '親和クリニックサイトトップページ画像')); ?>
                </figure>
            </div>
        </div>
        ...
        <div class="site_images">
            <div class="col2">
                <figure class="">
                    <?php echo $this->Html->image('works/site/works_shinwa_shinjuku_02.jpg', array('alt' => '親和クリニックサイトトップページ全画面画像')); ?>
                </figure>
                <figure class="">
                    <?php echo $this->Html->image('works/site/works_shinwa_shinjuku_03.jpg', array('alt' => '親和クリニックサイト下層ページ画像')); ?>
                </figure>
            </div>
            <div class="col1">
                <figure>
                    <?php echo $this->Html->image('works/site/works_shinwa_shinjuku_04.jpg', array('alt' => '親和クリニックサイトスマホデバイスモックアップ画像')); ?>
                </figure>
            </div>
        </div>
        <div class="link_box">
