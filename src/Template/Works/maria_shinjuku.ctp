...
<section class="bg_color_mono_clear padding_v_large">
    <div class="container">
        <h2 class="headline">
            マリアクリニック新宿院
            <span class="headline_large_en">maria clinic shinjuku</span>
        </h2>
        ...
        <div class="margin_b_medium bg_mono_light padding_medium">
            ...
            <div class="site_info">
                <div class="thmb_img margin_b_medium">
                    <figure>
                        <?php echo $this->Html->image('works/site/works_thmb_maria_shinjuku_pc.jpg', array('alt' => 'マリアクリニック新宿院サイトトップページ画像')); ?>
                    </figure>
                </div>
                <div class="site_info_text padding_medium">
                <h4 class="headline">クライアント</h4>
                    <p class="margin_b_medium">マリアクリニック新宿院</p>
                    <h4 class="headline">サイト規模</h4>
                    <p class="margin_b_medium">135ページ</p>
                    <h4 class="headline">URL</h4>
                    <p class="margin_b_medium">https://www.maria-cl.net/</p>
                    <h4 class="headline">月間PV数（2021/01）</h4>
                    <p class="margin_b_medium">2,805</p>
        ...
        <div class="site_images">
            <div class="col1">
                <figure>
                    <?php echo $this->Html->image('works/site/works_maria_shinjuku_01.jpg', array('alt' => 'マリアクリニック新宿院サイトトップページ画像')); ?>
                </figure>
            </div>
        </div>
        ...
        <div class="site_images">
            <div class="col2">
                <figure class="">
                    <?php echo $this->Html->image('works/site/works_maria_shinjuku_02.jpg', array('alt' => 'マリアクリニック新宿院サイトトップページ全画面画像')); ?>
                </figure>
                <figure class="">
                    <?php echo $this->Html->image('works/site/works_maria_shinjuku_03.jpg', array('alt' => 'マリアクリニック新宿院サイト下層ページ画像')); ?>
                </figure>
            </div>
            <div class="col1">
                <figure>
                    <?php echo $this->Html->image('works/site/works_maria_shinjuku_04.jpg', array('alt' => 'マリアクリニック新宿院サイトスマホデバイスモックアップ画像')); ?>
                </figure>
            </div>
        </div>
        <div class="link_box">
